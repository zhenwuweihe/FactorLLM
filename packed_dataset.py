...
class PackedDataset(IterableDataset):
    ...
    def __iter__(self):
        ...
        # print(max_num_files, num_shards)
    ...
    def train_test_split(self, n_test_files=1):
        n_files = len(self._filenames)
        n_test_files = max(1, n_test_files)
        n_train_files = n_files - n_test_files
        train_filenames = self._filenames[:n_train_files]

        test_filenames = self._filenames[n_train_files:]
